...
void set_device_double(double* d_dst, double x, cudaStream_t stream);
void copy_device_float_to_device_double(double* d_dst, const float* d_src, cudaStream_t stream);
