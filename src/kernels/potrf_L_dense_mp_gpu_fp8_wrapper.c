...
/**
 * @file potrf_L_dense_mp_gpu_fp8_wrapper.c
...
static int wrap_potrf(parsec_execution_stream_t * es, 
                      __parsec_potrf_L_dense_mp_gpu_fp8_potrf_dpotrf_task_t * this_task)
{
...
static int wrap_trsm(parsec_execution_stream_t * es,
                      __parsec_potrf_L_dense_mp_gpu_fp8_potrf_dtrsm_task_t * this_task)
{
    parsec_potrf_L_dense_mp_gpu_fp8_taskpool_t *parsec_tp = (parsec_potrf_L_dense_mp_gpu_fp8_taskpool_t*)this_task->taskpool;
...
static int wrap_syrk(parsec_execution_stream_t * es,
                      __parsec_potrf_L_dense_mp_gpu_fp8_potrf_dsyrk_task_t * this_task)
{
    parsec_potrf_L_dense_mp_gpu_fp8_taskpool_t *parsec_tp = (parsec_potrf_L_dense_mp_gpu_fp8_taskpool_t*)this_task->taskpool;
...
static int wrap_gemm(parsec_execution_stream_t * es,
                      __parsec_potrf_L_dense_mp_gpu_fp8_potrf_dgemm_task_t * this_task)
{
    parsec_potrf_L_dense_mp_gpu_fp8_taskpool_t *parsec_tp = (parsec_potrf_L_dense_mp_gpu_fp8_taskpool_t*)this_task->taskpool;
                      ...
                      __parsec_potrf_L_dense_mp_gpu_fp8_potrf_dgemm_task_t * this_task)
{
    ...
    // Log detailed GEMM execution information when timing is enabled
#if PRINT_KERNEL_TIME
    const char *sum_time_scope;
    int sum_time_id;
    double sum_time = hicma_kernel_time_accumulate((parsec_task_t *)this_task, parsec_tp->_g_params_tlr, es->th_id,
...
static parsec_hook_return_t evaluate_gpu_trsm(parsec_task_t* task) {
    int m = ((__parsec_potrf_L_dense_mp_gpu_fp8_potrf_dtrsm_task_t *)task)->locals.m.value;
    int k = ((__parsec_potrf_L_dense_mp_gpu_fp8_potrf_dtrsm_task_t *)task)->locals.k.value;
    int band_size_dense = ((__parsec_potrf_L_dense_mp_gpu_fp8_potrf_dtrsm_task_t *)task)->locals.band_size_dense_local.value;
...
static parsec_hook_return_t evaluate_gpu_gemm(parsec_task_t* task) {
    int m = ((__parsec_potrf_L_dense_mp_gpu_fp8_potrf_dgemm_task_t *)task)->locals.m.value;
    int n = ((__parsec_potrf_L_dense_mp_gpu_fp8_potrf_dgemm_task_t *)task)->locals.n.value;
    int k = ((__parsec_potrf_L_dense_mp_gpu_fp8_potrf_dgemm_task_t *)task)->locals.k.value;
    int band_size_dense = ((__parsec_potrf_L_dense_mp_gpu_fp8_potrf_dgemm_task_t *)task)->locals.band_size_dense_local.value;
 ...
 */
parsec_taskpool_t*
potrf_L_dense_mp_gpu_fp8_New( parsec_context_t *parsec,
        ...
        hicma_parsec_params_t *params )
{
    ...
    params->info = 0;
    parsec_potrf_L_dense_mp_gpu_fp8_taskpool_t *hicma_dpotrf =
        parsec_potrf_L_dense_mp_gpu_fp8_new( A, Ar, Rank, Fake, params ); 
    ...
    *hook = &wrap_gemm_complete;
    ...
    parsec_add2arena(&hicma_dpotrf->arenas_datatypes[PARSEC_potrf_L_dense_mp_gpu_fp8_FULL_DP_ADT_IDX],
            parsec_datatype_double_t, PARSEC_MATRIX_FULL,
            1, A->mb, A->mb, A->mb,
            PARSEC_ARENA_ALIGNMENT_SSE, -1 );

    parsec_add2arena(&hicma_dpotrf->arenas_datatypes[PARSEC_potrf_L_dense_mp_gpu_fp8_FULL_SP_ADT_IDX],
            parsec_datatype_float_t, PARSEC_MATRIX_FULL,
            1, A->mb, A->mb, A->mb,
            PARSEC_ARENA_ALIGNMENT_SSE, -1 );

    parsec_add2arena(&hicma_dpotrf->arenas_datatypes[PARSEC_potrf_L_dense_mp_gpu_fp8_UV_DP_ADT_IDX],
            parsec_datatype_double_t, PARSEC_MATRIX_FULL,
            1, A->mb, storagemaxrank*2, A->mb,
            PARSEC_ARENA_ALIGNMENT_SSE, -1 );

    parsec_add2arena(&hicma_dpotrf->arenas_datatypes[PARSEC_potrf_L_dense_mp_gpu_fp8_UV_SP_ADT_IDX],
            parsec_datatype_float_t, PARSEC_MATRIX_FULL,
            1, A->mb, storagemaxrank*2, A->mb,
            PARSEC_ARENA_ALIGNMENT_SSE, -1 );

    parsec_add2arena(&hicma_dpotrf->arenas_datatypes[PARSEC_potrf_L_dense_mp_gpu_fp8_BYTE_ADT_IDX],
            MPI_BYTE, PARSEC_MATRIX_FULL,
            1, 1, 1, 1,
            PARSEC_ARENA_ALIGNMENT_SSE, -1 );

    parsec_add2arena(&hicma_dpotrf->arenas_datatypes[PARSEC_potrf_L_dense_mp_gpu_fp8_FULL_HP_ADT_IDX],
            MPI_BYTE, PARSEC_MATRIX_FULL,
            1, A->mb, A->mb*2, A->mb, 
            PARSEC_ARENA_ALIGNMENT_SSE, -1 );

    parsec_add2arena(&hicma_dpotrf->arenas_datatypes[PARSEC_potrf_L_dense_mp_gpu_fp8_FULL_FP8_ADT_IDX],
            MPI_BYTE, PARSEC_MATRIX_FULL,
            1, A->mb, A->mb, A->mb,
            PARSEC_ARENA_ALIGNMENT_SSE, -1 );

    parsec_add2arena(&hicma_dpotrf->arenas_datatypes[PARSEC_potrf_L_dense_mp_gpu_fp8_AR_ADT_IDX],
    ...
    if( params->arena_pinned_memory && nb > 0 ) {
        hicma_parsec_arenas_use_pinned_memory(
                ...
                PARSEC_potrf_L_dense_mp_gpu_fp8_ADT_IDX_MAX);
    }
 ...
 */
void potrf_L_dense_mp_gpu_fp8_Destruct(parsec_taskpool_t* _tp)
{
    parsec_potrf_L_dense_mp_gpu_fp8_taskpool_t *tp = (parsec_potrf_L_dense_mp_gpu_fp8_taskpool_t*)_tp;
    ...
    parsec_del2arena( &tp->arenas_datatypes[PARSEC_potrf_L_dense_mp_gpu_fp8_FULL_DP_ADT_IDX] );
    parsec_del2arena( &tp->arenas_datatypes[PARSEC_potrf_L_dense_mp_gpu_fp8_FULL_SP_ADT_IDX] );
    parsec_del2arena( &tp->arenas_datatypes[PARSEC_potrf_L_dense_mp_gpu_fp8_FULL_HP_ADT_IDX] );
    parsec_del2arena( &tp->arenas_datatypes[PARSEC_potrf_L_dense_mp_gpu_fp8_FULL_FP8_ADT_IDX] );
    parsec_del2arena( &tp->arenas_datatypes[PARSEC_potrf_L_dense_mp_gpu_fp8_UV_DP_ADT_IDX] );
    parsec_del2arena( &tp->arenas_datatypes[PARSEC_potrf_L_dense_mp_gpu_fp8_UV_SP_ADT_IDX] );
    parsec_del2arena( &tp->arenas_datatypes[PARSEC_potrf_L_dense_mp_gpu_fp8_BYTE_ADT_IDX] );
    parsec_del2arena( &tp->arenas_datatypes[PARSEC_potrf_L_dense_mp_gpu_fp8_AR_ADT_IDX] );
        ...
        hicma_parsec_params_t *params )
{
    ...
    if( 0 == params->rank && params->verbose )
        printf(MAG "DENSE_MP_GPU_FP8 Start\n" RESET);

    // Create and configure the POTRF taskpool
    hicma_potrf = potrf_L_dense_mp_gpu_fp8_New( parsec, data, params );
    ...
    if( NULL != hicma_potrf ) {
        ...
        // Clean up resources
        potrf_L_dense_mp_gpu_fp8_Destruct( hicma_potrf );
